...
import br.com.exemplo.crud.jpa.repositories.PessoaFilter;
import br.com.exemplo.crud.services.PessoaService;
...
public class PessoaResource {
    ...
    @Operation(description = "Busca uma crud", responses = {
    ...
    @Operation(description = "Grava uma crud", responses = {
    ...
    @Operation(description = "Atualiza uma crud", responses = {
    ...
    @Operation(description = "Faz Upload de um arquivo para uma crud", responses = {
            @ApiResponse(responseCode = STATUS_NO_CONTENT, content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE))
    })
    ...
    @Operation(description = "Deleta uma crud", responses = {
            @ApiResponse(responseCode = STATUS_NO_CONTENT, content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE))
    })
